...
({
  {  --Большой Электрический бур
    ...
    minable = {mining_time = 0.6, result = "big-electric-mining-drill"},
    max_health = 600,
    ...
    input_fluid_box =
    {
      ...
      pipe_connections =
      {
        { direction = defines.direction.west, position = {-10, 0}},
        { direction = defines.direction.east, position = {10, 0}},
        { direction = defines.direction.south, position = {0, 10}}
      }
    },
    working_sound =
    {
    ...
    energy_usage = "5400kW",
    resource_searching_radius = 13.49,
    vector_to_place_result = {0, -10.85},
    module_slots = 3,
